<div>
    <div class="py-4 mx-auto px-6">
        <p class="text-capitalized text-center uppercase text-black dark:text-white tracking-tight mb-6">
        ...
        <div class="grid grid-cols-1 gap-4 items-center justify-center max-w-md mx-auto">
            <form wire:submit="store">
                <div class="bg-white flex items-center justify-between py-2 rounded-full shadow-lg mx-2">
                    ...
                    <button type="submit"
                        class="rounded-full bg-green-700 dark:bg-blue-700 active:bg-green-600 dark:active:bg-blue-600  grid place-items-center w-[56px] h-[56px]"
                        type="submit">
