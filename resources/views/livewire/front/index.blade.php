        ...
        <div class="grid xl:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4 items-center">
            ...
            <div class="flex flex-col mt-10 items-center space-y-6">
                <div
                    ...
                    <div
                        class="max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6 overflow-hidden bg-white bg-opacity-25 text-white dark:text-gray-800 rounded-full">
                    ...
                    <div class="w-full">
                        <h4 class="font-bold text-white dark:text-gray-800 text-xl mb-1">
                            {{ __('Our Location') }}
                        </h4>
                        <p class="text-base text-white dark:text-gray-800">
