<div>
    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-1/4 py-4 px-4">
            ...
            <div class="mt-4 flex items-center justify-between">
                <label for="is_gallery" class="mr-3 block">{{ __('Enable gallery') }}:</label>
                <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
            ...
            <div class="mt-4 flex items-center justify-between">
                <label for="is_services" class="mr-3 block">{{ __('Enable Services') }}:</label>
                <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                    <input type="checkbox" name="is_services" id="is_services" wire:model="settings.is_services"
                        @if ($settings['is_services']) checked @endif
                        class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                    <input type="checkbox" name="is_offer" id="is_offer" wire:model="settings.is_offer"
                        @if ($settings['is_offer']) checked @endif
                        class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" />
                    <label for="is_offer"
                        class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
                </div>
