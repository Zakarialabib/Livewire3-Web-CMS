                ...
                <x-table.tr>
                    ...
                    <x-table.td>
                        <div class="inline-flex">
                            ...
                            @endcan
                            @can('permission_edit')
                                <a class="font-bold border-transparent uppercase justify-center text-xs py-1 px-2 rounded shadow hover:shadow-md outline-none focus:outline-none focus:ring-2 focus:ring-offset-2 mr-1 ease-linear transition-all duration-150 cursor-pointer text-white bg-green-500 dark:bg-gray-700 border-green-800 hover:bg-green-600 active:bg-green-700 focus:ring-green-300mr-2"
