            ...
            <form wire:submit="update">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="w-full">
                        ...
                        <select id="placeholders" class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1" name="placeholders[]"
                    ...
                    <div class="w-full">
                        ...
                        <select id="type" class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1" name="type"
