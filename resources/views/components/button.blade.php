...
@php
    $classes =
        ($primary ? 'bg-gradient-to-r from-purple-800 via-violet-900 to-purple-800 text-white border border-transparent text-white hover:bg-purple-600 focus:ring-purple-500 active:bg-purple-900 focus:outline-none focus:border-purple-900' : '') .
        ...
        ($success ? 'bg-green-500 dark:bg-gray-700 border border-transparent text-white hover:bg-green-600 focus:ring-green-500 active:bg-green-900 focus:outline-none focus:border-green-900' : '') .
        ...
        ($primaryOutline ? 'bg-transparent border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white active:bg-purple-900 focus:outline-none focus:border-purple-900 focus:ring ring-purple-300' : '') .
