...
<th
    {{ $attributes->merge(['class' => 'p-3 text-left text-xs font-medium uppercase tracking-wider bg-gray-100 dark:bg-dark-eval-1 text-black dark:text-white'])->only('class') }}
>
    @unless ($sortable)
