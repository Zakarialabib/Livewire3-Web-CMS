...
@php
$isActiveClasses = $isActive ? 'bg-green-500 text-white active:bg-green-500' : 'text-white hover:text-green-500 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-dark-eval-2';
$classes = 'flex items-center hover:text-white hover:bg-green-500 pl-3 py-3 pr-4 rounded ' . $isActiveClasses;
if ($collapsible) {
    $classes .= ' w-full';
}
@endphp
